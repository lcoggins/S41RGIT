...
zipform=formula(fishseen~ y + wc + cd + sc + bd + d + t + lat + temp +offset(frames)|y + wc + cd + sc + bd + d + t + lat + temp +offset(frames))
zipmod=zeroinfl(zipform,  dist = "poisson", link = "logit",data=dat);summary(zipmod)

nbform=formula(fishseen~ y + wc + cd + sc + bd + d + t + lat + temp +offset(frames)|y + wc + cd + sc + bd + d + t + lat + temp +offset(frames))
