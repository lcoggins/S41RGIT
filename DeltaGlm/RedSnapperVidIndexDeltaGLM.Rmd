...
errbar(x=yrs,y=U.std,yplus=U.std+1.96*error.std,yminus=U.std-1.96*error.std, ylab='Relative CPUE (Mean Count)', xlab='Year', lwd=2, ylim=c(0,4))
...
errbar(x=yrs,y=U,yplus=U+1.96*error.U,yminus=U-1.96*error.U, ylab='CPUE (Mean Count)', xlab='Year', lwd=2, ylim=c(0,0.25))
grid(col="lightgray")
lines(yrs,U,lwd=2)
...
plot(datbin$t,qr.binom,xlab="Season",main="Residuals: proportion positive")
...
#plot(datpos$tod,pos.resids,xlab="Time Of Day",main="Residuals (pos CPUE)")
