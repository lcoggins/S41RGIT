...
rs=read.csv("\\\\CCFHR-S-1534090\\popdyn1\\SEDAR\\SEDAR 41\\SEFISIndices\\RedSnapGLMData.csv")#;head(rs```
...
jags.inits = function(){list(bet = rnorm(45,0,.15),alph=rnorm(1,0,.15))}
